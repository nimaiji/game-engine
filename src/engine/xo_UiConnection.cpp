...
JNIEXPORT jboolean JNICALL Java_xo_UiConnection_start (JNIEnv * env, jobject obj, jint x, jint y, jstring name1, jstring name2,jobject isAuto1,jobject isAuto2) {
...
JNIEXPORT jint JNICALL Java_xo_UiConnection_botMove(JNIEnv *env, jobject obj){
...
JNIEXPORT jboolean JNICALL Java_xo_UiConnection_isOver(JNIEnv * env, jobject obj){
